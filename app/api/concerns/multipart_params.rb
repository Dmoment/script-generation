  ...
  included do
    helpers do
      ...
      def extract_multipart_params(form_params, required_fields: [], file_field: 'file')
        ...
        # Extract file if present - ActiveStorage can handle ActionDispatch::Http::UploadedFile directly
...

        {
          ...
          file: uploaded_file, # Pass ActionDispatch::Http::UploadedFile directly
          errors: errors
        }
      end
    end
