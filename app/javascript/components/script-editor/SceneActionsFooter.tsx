  ...
  return (
    <div className="relative bg-white">
      ...
      >
        ...
        <div
          ref={menuRef}
          className={`absolute bottom-full left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-out ${
            isMenuOpen
          ...
          <div className="relative">
            ...
            >
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full bg-white border-2 border-black flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 ease-out z-10 ${
                  isMenuOpen
                    ? "translate-y-0 translate-x-0 opacity-100 scale-100"
                    : "translate-y-12 translate-x-0 opacity-0 scale-75"
                }`}
                style={{
                ...
                (() => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full bg-white border-2 flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 ease-out z-10 ${
                        isMenuOpen
                          ? "translate-y-0 translate-x-0 opacity-100 scale-100"
                          : "translate-y-12 translate-x-0 opacity-0 scale-75"
                      }`}
                ...
                (() => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-10 h-10 rounded-full bg-white border-2 border-red-600 flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 ease-out z-10 ${
                        isMenuOpen
                          ? "translate-y-0 translate-x-0 opacity-100 scale-100"
                          : "translate-y-12 translate-x-0 opacity-0 scale-75"
                      }`}
